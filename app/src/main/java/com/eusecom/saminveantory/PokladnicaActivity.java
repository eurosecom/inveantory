...
public class PokladnicaActivity extends ListActivity implements SimpleGestureListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if( caty.equals("1")) {
            this.setTitle(getResources().getString(R.string.popisstavean) + " " + getResources().getString(R.string.page) + " " + pagey);
        }
        if( caty.equals("2")) {
            this.setTitle(getResources().getString(R.string.popisstavcis) + " " + getResources().getString(R.string.page) + " " + pagey);
        }
        if( caty.equals("3")) {
            this.setTitle(getResources().getString(R.string.popisstavnat) + " " + getResources().getString(R.string.page) + " " + pagey);
        }
        if( caty.equals("4")) {
            this.setTitle(getResources().getString(R.string.popisstavhod) + " " + getResources().getString(R.string.page) + " " + pagey);
        }
    ...
    @Override 
	  ...
	  public void onSwipe(int direction) {
	   ...
	   case SimpleGestureFilter.SWIPE_RIGHT : 
		   ...
		   if( caty.equals("1")) { str = getString(R.string.popisstavean); }
		   if( caty.equals("2")) { str = getString(R.string.popisstavcis); }
		   if( caty.equals("3")) { str = getString(R.string.popisstavnat); }
		   if( caty.equals("4")) { str = getString(R.string.popisstavhod); }
